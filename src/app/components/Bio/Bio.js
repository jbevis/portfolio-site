  ...
  return (
    <section id='bio'>
      ...
      <div className='text-area'>
        ...
        <p>After finishing my education in anthropology and GIS, I have worked in different industries ranging from restaurants to digital marketing, all while honing my skills in customer service and management. I chose to become a software developer because I am drawn to its collaborative and creative nature. Software development allows one to be constantly engaged and consistently pushing one's abilities and skills. Ultimately though I enjoy software development because the number of challenges are only outnumbered by the unique and dynamic ways to solve them.</p>
